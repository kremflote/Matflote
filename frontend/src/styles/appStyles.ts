...
export const segmentedToggleStyles = {
  ...
  option: (theme: SiteTheme, selected: boolean) =>
    `flex h-[26px] min-w-0 flex-1 items-center justify-center ${radiusClasses.figma6} px-3 text-xs font-semibold transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-55 ${
      selected
