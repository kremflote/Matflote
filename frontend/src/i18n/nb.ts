...
export const nb: TranslationDictionary = {
  ...
  common: {
    ...
    collapse: "Skjul",
    expand: "Vis",
    ingredientAdded: (name) => `${name} ble lagt til.`,
  ...
  cookbook: {
    ...
    addSides: "Legg til oppskrifter",
    addSidesHelp:
      "Legg til sauser, dipper eller andre oppskrifter som målte deler av denne oppskriften.",
    ...
    chooseRecipes: "Velg oppskrifter",
    ...
    addConversionRule: "Legg til konvertering",
    conversionFrom: "Fra",
    conversionTo: "Til",
    conversionFromPlaceholder: "1 egg",
    conversionToPlaceholder: "60 g",
    conversionRuleNeedsValues: "Fyll inn begge sider av konverteringen.",
    couldNotDeleteConversionRule: "Kunne ikke fjerne konverteringen.",
    couldNotLoadConversionRules: "Kunne ikke laste konverteringer.",
    couldNotSaveConversionRule: "Kunne ikke lagre konverteringen.",
    cookbookSections: "Kokebokseksjoner",
    create: "Opprett",
    createIngredient: "Opprett ingrediens",
    createRecipe: "Opprett oppskrift",
    createSideRecipeFirst:
      "Lag en annen oppskrift først.",
    ...
    noRecipesSelected: "Ingen oppskrifter valgt.",
    noInstructions: "Ingen fremgangsmåte ennå.",
    noPrice: "Ingen pris",
    noRecipesFound: "Ingen oppskrifter funnet",
    noSidesAdded: "Ingen oppskrifter lagt til.",
    nutrition: "Næring",
    nutritionFats: "Fett",
    ...
    recipeComponentAmountRequired: "Velg mengde for hver valgte oppskrift.",
    recipeLineMode: "Type oppskriftslinje",
    recipeLinesHelp: "Legg til ingredienser direkte, eller bruk en annen oppskrift som målt ingrediens.",
  ...
  nutrition: {
    ...
    items: {
      ...
      salt: "Salt",
      fiber: "Fiber",
      saturatedFat: "Mettet fett",
      transFat: "Transfett",
      monounsaturatedFat: "Enumettet fett",
      polyunsaturatedFat: "Flerumettet fett",
      omega3: "Omega-3",
      vitaminA: "Vitamin A",
      vitaminB9: "Vitamin B9",
      vitaminB12: "Vitamin B12",
    ...
    statusLabels: {
      ...
      high: "Trolig høyt",
      low: "Trolig lavt",
      lowCoverage: "Lav dekning",
      ok: "Ser greit ut",
      watch: "Verdt å sjekke",
    },
  ...
  scanner: {
    ...
    searchAndFillMatvaretabellen: "Søk og fyll manglende felt fra Matvaretabellen.no",
    ...
    pageIntroAfterKassalapp:
      " ved å skrive inn en strekkode/EAN eller skanne en strekkode.",
    pageTitle: "Skanner",
    price: (price) =>
  ...
  planner: {
    ...
    moveMealAmountLabel: (unit) => `Mengde å flytte${unit === "" ? "" : ` (${unit})`}`,
    moveMealBody: (label) =>
      `Velg hvor mye av ${label} som skal flyttes til den tomme måltidsplassen. Flytter du hele mengden, tømmes den opprinnelige plassen.`,
    moveMealConfirm: "Flytt måltid",
    moveMealPortionsLabel: "Porsjoner å flytte",
    moveMealTitle: "Flytt måltid",
    ...
    couldNotMoveMeal: "Kunne ikke flytte dette måltidet. Prøv igjen.",
  ...
  settings: {
    ...
    checkImages: "Sjekk bilder",
    checkingImages: "Sjekker...",
    cleanupImages: "Rydd bilder",
    cleaningImages: "Rydder...",
    couldNotCheckImages: "Kunne ikke sjekke bilder.",
    couldNotCleanupImages: "Kunne ikke rydde bilder.",
    ...
    helsedirektoratetSubscriptionKey: "Helsedirektoratet-abonnementsnøkkel",
    helsedirektoratetSubscriptionKeyPlaceholder: "Lim inn abonnementsnøkkel",
    imageStorage: "Bildelagring",
    imageCleanupFinished: "Bilderydding fullført.",
    imageCleanupSummary: (unusedUploads, untrackedFiles) =>
      `${unusedUploads} ubrukte opplastede bilde(r), ${untrackedFiles} usporede bildefil(er).`,
    importSeedCatalog: "Importer katalog-JSON",
    importingSeedCatalog: "Importerer...",
    importSeedCatalogFinished: "Startkatalog importert.",
    integrationsBody:
      "Konfigurer eksterne tjenester som brukes til handlelister, produktoppslag og næringsreferanser.",
    integrationsTitle: "Integrasjoner",
    kassalappApiKey: "Kassalapp API-nøkkel",
    kassalappApiKeyPlaceholder: "Lim inn API-nøkkel",
    ...
    languageTitle: "Språk",
    maintenanceBody:
      "Last ned en komplett datapakke eller rydd opp i ubrukte bildefiler.",
    maintenanceTitle: "Vedlikehold",
    downloadExportPackage: "Last ned eksportpakke",
    ...
    scannerIntegrationBody:
      "Brukes av Skanner-siden til oppslag av norske dagligvarer.",
    scannerIntegrationTitle: "Produktskanner",
    todoListTitle: "Todo-liste",
