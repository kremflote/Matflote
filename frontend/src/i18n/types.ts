...
export type TranslationDictionary = {
  ...
  settings: {
    ...
    checkImages: string;
    checkingImages: string;
    cleanupImages: string;
    cleaningImages: string;
    couldNotCheckImages: string;
    couldNotCleanupImages: string;
    ...
    helsedirektoratetBaseUrlPlaceholder: string;
    helsedirektoratetSubscriptionKey: string;
    helsedirektoratetSubscriptionKeyPlaceholder: string;
    imageStorage: string;
    imageCleanupFinished: string;
    imageCleanupSummary: (unusedUploads: number, untrackedFiles: number) => string;
    importSeedCatalog: string;
    importingSeedCatalog: string;
    importSeedCatalogFinished: string;
    integrationsBody: string;
    integrationsTitle: string;
    kassalappApiKey: string;
    kassalappApiKeyPlaceholder: string;
    kassalappBaseUrl: string;
    kassalappBaseUrlPlaceholder: string;
    languageBody: string;
    languageTitle: string;
    maintenanceBody: string;
    maintenanceTitle: string;
    downloadExportPackage: string;
    pageTitle: string;
    projectId: string;
    provider: string;
    ...
    systemBody: string;
    systemTitle: string;
    scannerIntegrationBody: string;
    scannerIntegrationTitle: string;
