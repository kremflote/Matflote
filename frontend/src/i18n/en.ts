...
export const en: TranslationDictionary = {
  ...
  planner: {
    ...
    moveMealAmountLabel: (unit) => `Amount to move${unit === "" ? "" : ` (${unit})`}`,
    moveMealBody: (label) =>
      `Choose how much of ${label} to move into the empty meal slot. Leaving the full amount will clear the original slot.`,
    moveMealConfirm: "Move meal",
    moveMealPortionsLabel: "Portions to move",
    moveMealTitle: "Move meal",
    ...
    couldNotMoveMeal: "Could not move this meal. Please try again.",
